...
tinycli_register("h0", f_h0, v)
tinycli_register("h1", f_h1, v)
tinycli_register("h2", f_h2, v)
tinycli_register_immediate('\xF0', f_im0)
tinycli_register_immediate('\xF1', f_im1)
