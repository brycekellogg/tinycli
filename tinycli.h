...
void tinycli_register_diiiii (const char* cmd, int (*f)(double,int,int,int,int,int));
...
#define tinycli_register(cmd, func) _Generic((func),              \
    ...
    int(*)(double,int,int,int,int):     tinycli_register_diiii,   \
    int(*)(double,int,int,int,int,int): tinycli_register_diiiii) (cmd, func)
